// Service Worker for Rust Code UI PWA
...
self.addEventListener('push', event => {
  ...
  try {
    ...
    payload = { title: 'Rust Code UI', body: event.data.text() };
  }
  ...
  event.waitUntil(
    self.registration.showNotification(payload.title || 'Rust Code UI', options)
  );
});
